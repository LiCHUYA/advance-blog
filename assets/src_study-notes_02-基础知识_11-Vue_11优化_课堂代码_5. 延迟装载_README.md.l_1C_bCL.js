...
const __pageData = JSON.parse('{"title":"demo5","description":"","frontmatter":{},"headers":[],"relativePath":"src/study-notes/02-基础知识/11-Vue/11优化/课堂代码/5. 延迟装载/README.md","filePath":"src/study-notes/02-基础知识/11-Vue/11优化/课堂代码/5. 延迟装载/README.md","lastUpdated":1739501366000}');
const _sfc_main = { name: "src/study-notes/02-基础知识/11-Vue/11优化/课堂代码/5. 延迟装载/README.md" };
const _hoisted_1 = /* @__PURE__ */ createBaseVNode("h1", {
  id: "demo5",
  tabindex: "-1"
}, [
  /* @__PURE__ */ createTextVNode("demo5 "),
  /* @__PURE__ */ createBaseVNode("a", {
    class: "header-anchor",
    href: "#demo5",
    "aria-label": 'Permalink to "demo5"'
  }, "​")
], -1);
