...
const __pageData = JSON.parse('{"title":"demo1","description":"","frontmatter":{},"headers":[],"relativePath":"src/study-notes/02-基础知识/11-Vue/10过渡和动画/课件/demo1/README.md","filePath":"src/study-notes/02-基础知识/11-Vue/10过渡和动画/课件/demo1/README.md","lastUpdated":1739501366000}');
const _sfc_main = { name: "src/study-notes/02-基础知识/11-Vue/10过渡和动画/课件/demo1/README.md" };
