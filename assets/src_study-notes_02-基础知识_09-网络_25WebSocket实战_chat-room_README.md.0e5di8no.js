...
const __pageData = JSON.parse('{"title":"chat-room","description":"","frontmatter":{},"headers":[],"relativePath":"src/study-notes/02-基础知识/09-网络/25WebSocket实战/chat-room/README.md","filePath":"src/study-notes/02-基础知识/09-网络/25WebSocket实战/chat-room/README.md","lastUpdated":1739501366000}');
const _sfc_main = { name: "src/study-notes/02-基础知识/09-网络/25WebSocket实战/chat-room/README.md" };
const _hoisted_1 = /* @__PURE__ */ createBaseVNode("h1", {
  id: "chat-room",
  tabindex: "-1"
}, [
  /* @__PURE__ */ createTextVNode("chat-room "),
  /* @__PURE__ */ createBaseVNode("a", {
    class: "header-anchor",
    href: "#chat-room",
    "aria-label": 'Permalink to "chat-room"'
  }, "​")
], -1);
