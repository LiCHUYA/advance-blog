...
const __pageData = JSON.parse('{"title":"demo","description":"","frontmatter":{},"headers":[],"relativePath":"src/study-notes/02-基础知识/11-Vue/13长列表优化/课堂代码/demo/README.md","filePath":"src/study-notes/02-基础知识/11-Vue/13长列表优化/课堂代码/demo/README.md","lastUpdated":1739501366000}');
const _sfc_main = { name: "src/study-notes/02-基础知识/11-Vue/13长列表优化/课堂代码/demo/README.md" };
