...
const __pageData = JSON.parse('{"title":"demo","description":"","frontmatter":{},"headers":[],"relativePath":"src/study-notes/02-基础知识/11-Vue/19路由切换动画/课件/demo/README.md","filePath":"src/study-notes/02-基础知识/11-Vue/19路由切换动画/课件/demo/README.md","lastUpdated":1739501366000}');
const _sfc_main = { name: "src/study-notes/02-基础知识/11-Vue/19路由切换动画/课件/demo/README.md" };
